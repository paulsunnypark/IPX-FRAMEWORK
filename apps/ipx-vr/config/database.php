...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Master DB (SSO/Auth) - IPX-Framework Multi-Database
        'mysql_master' => [
            'driver' => 'mysql',
        ...
        // VR DB (Recording/AI) - IPX-Framework Multi-Database
        'mysql_vr' => [
            'driver' => 'mysql',
            'url' => env('DB_VR_URL'),
            'host' => env('DB_VR_HOST', '127.0.0.1'),
            'port' => env('DB_VR_PORT', '3306'),
            'database' => env('DB_VR_DATABASE', 'ipx_vr'),
            'username' => env('DB_VR_USERNAME', 'ipx_app'),
            'password' => env('DB_VR_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
